...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isUIAutomationService(AndroidServerService.class)) {
            tv_service.setText("uia2-agent is running");
        }
        else {
            tv_service.setText("uia2-agent is not running");
        }
    ...
    public void start(View view) {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(),"Some errors in app. Please report an issue to https://github.com/uia2/android-uiautomator2-server", Toast.LENGTH_LONG).show();
            tv_service.setText("uia2-agent is not running");
